var TableDatatablesEditable = function () {
    ...
    var handleTable = function () {
        ...
        function deleteRow(id){
        	$.ajax({
        		"type": 'POST',
        		"url" : '/creditOrderStatesDeleteOne',
        		"data": id,
        		"success": success,
        		"error": error,
        ...
        function addOrUpdateRow(id, name){
        	$.ajax({
        		"type": 'POST',
        		"url" : '/creditOrderStatesAddOrUpdate',
        ...
        $('#sample_editable_1_new').click(function (e) {
            ...
            if (nNew && nEditing) {
                if (confirm("Previos row not saved. Do you want to save it ?")) {
        ...
        table.on('click', '.delete', function (e) {
            ...
            deleteRow(nRow.cells[0].innerHTML);
        });
        ...
        table.on('click', '.edit', function (e) {
            ...
            if (nEditing !== null && nEditing != nRow) {
                ...
                addOrUpdateRow(nRow.cells[0].innerHTML, nRow.cells[1].innerHTML);
                location.reload();
            } else {
