var TableDatatablesEditable = function() {
    var e = function() {
        ...
        function t(e, t) {
            ...
            a[1].innerHTML = '<a class="edit" href="">Save</a>', 
            a[2].innerHTML = '<a class="cancel" href="">Cancel</a>'
        }
        ...
        function n(e, t) {
            ...
            e.fnUpdate('<a class="edit" href="">Edit</a>', t, 1, !1), 
            e.fnUpdate('<a class="delete" href="">Delete</a>', t, 2, !1), 
            e.fnDraw()
        }
        ...
        $("#sample_editable_1_new").click(function(e) {
            if (e.preventDefault(), o && r) {
                if (!confirm("Previos row not saved. Do you want to save it ?")) return l.fnDeleteRow(r), r = null, void(o = !1);
